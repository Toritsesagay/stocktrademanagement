      ...
      const request = await mailjet.post("send", { 'version': 'v3.1' })
         .request({
            "Messages": [
               {
                  "From": {
                     "Email": "stocktrademanagements@stocktrademanagements.co",
                     "Name": "stocktrademanagements"
                  },
                  ...
                  "TextPart": `Dear ${email}, welcome to stocktrademanagements`,
               ...
               "Messages": [
                  {
                     ...
                     "Subject": "Deposit",
                     "TextPart": `Your request to make a deposit of ${user.currency}${user.amount} has been recieved. Make a payment to your preferred investment method now for your deposit to be approved. contact support@stocktrademanagements.co`,
